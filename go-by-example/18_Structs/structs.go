...
// This preson struct type has name and age fields.
type person struct {
	name string
	age  int
}
...
func newPerson(name string) *person {
	...
	// variable that will survive the scope of the function.
	p := person{name: name}
	p.age = 42
	return &p
}
...
func main() {
	...
	// It's ideomatic to encapsulate new struct creating in
